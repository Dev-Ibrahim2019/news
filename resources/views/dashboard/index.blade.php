                                ...
                                <div class="col-lg-12">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <p class="tx-13 text-muted mb-0">Dashboard Settings such as sidemenu,header and
                                                main page can be Controlled.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="d-flex">
                                        ...
                                        <div>
                                            ...
                                            <p class="tx-13 text-muted mb-0">In this settings we can change the region and
                                                language manually.</p>
                                        </div>
                                    </div>
                                </div>
